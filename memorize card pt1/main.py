...
class Tile(pygame.sprite.Sprite):
    def __init__(self, filename, x, y):
        ...
        pygame.draw.rect(self.back_image, PURPLE, self.back_image.get_rect())
...
class Game():
    def __init__(self):
        ...
        # aliens
        self.all_aliens = [f for f in os.listdir('images/cards') if os.path.join('images/cards', f)]

        self.img_width, self.img_height = (150, 150)
        self.padding = 20
        self.margin_top = WINDOW_HEIGHT //4
        self.cols = 4
        self.rows = 2
    ...
    def draw(self):
        ...
        next_rect = next_text.get_rect(midbottom = (WINDOW_WIDTH // 2, WINDOW_HEIGHT - (WINDOW_HEIGHT//10)))
    ...
    def get_video(self):
        self.cap = cv2.VideoCapture('video/Full_Frame.mp4')
        self.success, self.img = self.cap.read()
